export const PostEditForm = ({title="", content="", file="", onTitleChange, onContentChange, onFileChange}) =>{
    return (
        <div className="post-write-container">
            ...
            <input id="postTitle" type="text" maxLength="26" placeholder="제목을 입력해주세요. (최대 26글자)" value={title} onChange={(event)=>{onTitleChange(event.target.value)}}></input>

            <label htmlFor="postContent">내용*</label>
            <textarea id="postContent" placeholder="내용을 입력해주세요." value={content} onChange={(event)=>{onContentChange(event.target.value)}}></textarea>
